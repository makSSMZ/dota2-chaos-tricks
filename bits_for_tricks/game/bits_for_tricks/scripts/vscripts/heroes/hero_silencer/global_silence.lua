LinkLuaModifier( "modifier_ability_global_silence", "heroes/hero_silencer/global_silence", LUA_MODIFIER_MOTION_NONE )

silencer_global_silence_datadriven = {}

function silencer_global_silence_datadriven:OnSpellStart()
