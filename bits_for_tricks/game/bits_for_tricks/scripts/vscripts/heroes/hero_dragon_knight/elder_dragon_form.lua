...
LinkLuaModifier( "modifier_ability_elder_dragon_form", "heroes/hero_dragon_knight/elder_dragon_form", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_elder_dragon_form_corrosive", "heroes/hero_dragon_knight/elder_dragon_form", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_elder_dragon_form_frost", "heroes/hero_dragon_knight/elder_dragon_form", LUA_MODIFIER_MOTION_NONE )

function elder_dragon_form_datadriven:OnSpellStart()
...
function modifier_ability_elder_dragon_form:OnCreated( kv )
	...
	--Запоминаем тип атаки. Fixed 30.01.2022
...
function modifier_ability_elder_dragon_form:OnDestroy()
	...
	--Возвращаем тип атаки. Fixed 30.01.2022
	local caster = self.parent
